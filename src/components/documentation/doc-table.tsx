...
export async function DocTable() {
  const pdfFiles = [
    ...
    {
      id: 3,
      fileName: "Complete-Examination-Certificate.pdf",
      path: "/pdf/Complete-Examination-Certificate.pdf",
    },
    { id: 4, fileName: "TU-GET-PBT.pdf", path: "/pdf/TU-GET-PBT.pdf" },
    { id: 5, fileName: "GDSC_basicLinux101.pdf", path: "/pdf/GDSC_basicLinux101.pdf" },
    { id: 6, fileName: "GDSC_react101.pdf", path: "/pdf/GDSC_react101.pdf" },
    { id: 7, fileName: "GDSC_figma101.pdf", path: "/pdf/GDSC_figma101.pdf" },
    {
      id: 8,
    ...
    { id: 10, fileName: "Letter-NSTDA-NECTEC.pdf", path: "/pdf/Letter-NSTDA-NECTEC.pdf" },
    { id: 11, fileName: "Letter-GJ-ARS.pdf", path: "/pdf/Letter-GJ-ARS.pdf" },
  ];
