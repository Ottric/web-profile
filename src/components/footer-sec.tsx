    ...
    <footer className="bg-card border-border border-t pb-12 md:pb-0">
      <div className="container flex max-w-screen flex-col px-6 py-4">
        ...
        <div className="text-muted-foreground flex items-center justify-between gap-2 text-xs sm:flex-row sm:text-sm md:text-base">
          ...
          <section className="ml-4 inline-flex gap-2 align-baseline whitespace-nowrap">
            <Link href="#X" className="cursor-pointer">
              <svg
            ...
            <Link href="#github" className="cursor-pointer">
              <Github size={26} className="p-0.5" />
            </Link>
            <Link href="#instagram" className="cursor-pointer">
              <Instagram size={26} className="p-0.5" />
            </Link>
          </section>
        </div>
      </div>
